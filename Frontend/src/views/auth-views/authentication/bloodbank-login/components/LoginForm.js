...
import { BLOODBANK_PREFIX_PATH, APP_PREFIX_PATH, BLOODBANK_ROLE, setTokenMeta } from 'configs/AppConfig'
...
const ValidateUser = (role) => {
	...
	if(mytoken){
		...
		if(decoded.role == role){
			window.location = BLOODBANK_PREFIX_PATH;
		}
		else{
			localStorage.clear();
