...
import { BILLING_PREFIX_PATH, APP_PREFIX_PATH, BILLING_ROLE, setTokenMeta } from 'configs/AppConfig'
...
const ValidateUser = (role) => {
	...
	if(mytoken){
		...
		if(decoded.role == role){
			window.location = BILLING_PREFIX_PATH;
		}
		else{
			localStorage.clear();
